...
<div style="text-align: center; margin: 1.5rem 0;">
  ...
  />
  <p style="color: #94A3B8; font-size: 0.85rem; margin-top: 0.5rem;">GIF atualizado automaticamente pelo CI a cada push</p>
</div>
...
<Tabs>
  ...
  <TabItem label="Central de Estudos">
    <img
      ...
      style="width:100%; border-radius:8px; border:1px solid #252F46;"
    />
    **Central de Estudos** — 19 tópicos estruturados com formulação matemática LaTeX, quizzes de fixação interativos, snippets de código C#/XAML e referências oficiais da Microsoft Learn.
  </TabItem>
  <TabItem label="Laboratório">
    <img
      src="/screenshots/laboratorio.png"
      alt="Laboratório de Código — editor C# ao vivo com compilação Roslyn e testes unitários"
      style="width:100%; border-radius:8px; border:1px solid #252F46;"
    />
    **Laboratório de Código** — 15 lições com editor C# ao vivo com compilação Roslyn em tempo real, testes unitários automatizados, renderização visual dinâmica e gabarito oficial com 1 clique.
  </TabItem>
  <TabItem label="Estúdio de Projetos">
    <img
      src="/screenshots/estudio.png"
      alt="Estúdio de Projetos — janela dedicada maximizável com layout retrátil e exportador Visual Studio 2022"
      style="width:100%; border-radius:8px; border:1px solid #252F46;"
    />
    **Estúdio de Projetos** — 9 templates executáveis, janela independente maximizável com suporte a múltiplos monitores, layout retrátil, shaders ao vivo e exportador automático para soluções completas do Visual Studio 2022 em .zip.
  </TabItem>
</Tabs>
...
<CardGrid>
  ...
  />
  <LinkCard
    title="1. Guia para Iniciantes (15 Lições C#)"
    description="Trilha de aprendizado cobrindo tipos primitivos (byte, uint), ponteiros unsafe, Data Binding reativo, templates 2D, malhas 3D e cinemática hierárquica."
  ...
  <LinkCard
    ...
    description="Grafos de cena para robôs articulados e quadrúpedes com propagação matricial em cadeia pai-filho e cinemática direta."
...
4. **Para estudantes universitários:** Consulte o [Mapeamento do Plano de Ensino](/academico/mapeamento-do-plano/) para encontrar os conteúdos correspondentes às atividades práticas e teóricas.
