...
| **SemVer / MSBuild Versioning** | *Versionamento Semântico* | Gerenciamento determinístico de versão (`v1.0.x`) sincronizado entre o compilador BAML do WPF, runtime C# e releases GitHub. |
